...
- The query parameters are appended to the URL you would normally use for adsb-map.
- Before the first query parameter a question mark ? is prepended, for each additional parameter an ampersand & is prepended.
- Example: http://192.168.x.yy/adsb-map/?icao=456789&enableLabels&extendedLabels=2&trackLabels&zoom=11&mapDim=0.4
...
- Query parameters in adsb-map are not case sensitive.
